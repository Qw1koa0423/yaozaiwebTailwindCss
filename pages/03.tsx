      ...
      <div className="flex flex-col p-6 m-3 space-y-10 bg-white rounded-2xl shadow-2xl md:flex-row md:space-y-0 md:space-x-10 md:m-0 md:p-16">
        <div>
          <Image
            ...
            height={0}
            width={0}
            className="mx-auto w-60 hover:scale-105 duration-200 transform"
          />
        </div>
        <div className="flex flex-col space-y-3">
          <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
            ...
            <div className="max-w-sm text-2xl font-semibold">
            ...
            <div className="group">
              <button className="w-full transition-all duration-150 bg-blue-700 text-white border-b-8 border-b-blue-700  rounded-lg group-hover:border-t-8 group-hover:border-b-0 group-hover:bg-blue-700 group-hover:border-t-blue-700 group-hover:shadow-lg">
                <div className="px-8 py-4 duration-150 bg-blue-500 rounded-lg group-hover:bg-blue-600">
                  加入购物车
                </div>
              </button>
            </div>
          ...
          <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
            <button
              className="flex items-center justify-center py-3 px-5 space-x-3 border-2 bg-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-lg hover:-translate-y-0.5
